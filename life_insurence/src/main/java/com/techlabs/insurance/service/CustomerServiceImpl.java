...
//			
	...
	@Override
	public String addcustomer(CustomerPostDto customerDto) {
		...
		Set<Role> role = new HashSet<>();
		  ...
		  login.setRoles(role);
		  ct.setLogin(login);
		  ct.setUsername(customerDto.getUsername()); 
		  System.out.println("-----------------------------------------------");
		  customerRepository.save(ct);
		Message message = new Message();
		//message.setStatus(HttpStatus.OK);
	...
	public Page<AccountDto> getCustomerAccounts(Pageable pageable, long id) {
	    ...
	    if (!customerOpt.isPresent()) {
	        throw new InsuranceException("Customer with ID " + id + " does not exist!");
	    }
	...
	public Customer registerCustomer(CustomerPostDto customerPostDto) {
	    ...
	    Login login = new Login();
	    login.setPassword(customerPostDto.getPassword()); // Assuming Login has setPassword method
	    customer.setLogin(login);

	    // Create and set UserDetails object
	    ...
	    address.setHouseNo(customerPostDto.getHouseNo());
	    address.setApartment(customerPostDto.getApartment());
	    address.setCity(customerPostDto.getCity());
	    address.setState(customerPostDto.getState());
	    address.setPincode(customerPostDto.getPincode());
